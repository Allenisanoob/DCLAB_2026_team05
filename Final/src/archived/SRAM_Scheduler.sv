module SRAM_Scheduler(
    ...
    always_comb begin
        ...
        case (req_cnt)
            ...
            3'd1 : begin
                if (i_B0_read_req)  req_p1 = {2'b00, 1'b0, i_B0_r_addr, 16'd0};
                if (i_B0_write_req) req_p1 = {2'b00, 1'b1, i_B0_w_addr, i_B0_w_data};
                if (i_B1_read_req)  req_p1 = {2'b01, 1'b0, i_B1_r_addr, 16'd0};
                if (i_B1_write_req) req_p1 = {2'b01, 1'b1, i_B1_w_addr, i_B1_w_data};
                if (i_B2_read_req)  req_p1 = {2'b10, 1'b0, i_B2_r_addr, 16'd0};
                if (i_B2_write_req) req_p1 = {2'b10, 1'b1, i_B2_w_addr, i_B2_w_data};
                if (i_B3_read_req)  req_p1 = {2'b11, 1'b0, i_B3_r_addr, 16'd0};
                if (i_B3_write_req) req_p1 = {2'b11, 1'b1, i_B3_w_addr, i_B3_w_data};
                req_p2 = 39'd0;
                req_p3 = 39'd0;
                req_p4 = 39'd0;
            end
            3'd2 : begin
                if (B0_rq && B1_rq) begin
                    if (i_B0_read_req)  req_p1 = {2'b00, 1'b0, i_B0_r_addr, 16'd0};
                    if (i_B0_write_req) req_p1 = {2'b00, 1'b1, i_B0_w_addr, i_B0_w_data};
                    if (i_B1_read_req)  req_p2 = {2'b01, 1'b0, i_B1_r_addr, 16'd0};
                    if (i_B1_write_req) req_p2 = {2'b01, 1'b1, i_B1_w_addr, i_B1_w_data};
                end
                if (B0_rq && B2_rq) begin
                    if (i_B0_read_req)  req_p1 = {2'b00, 1'b0, i_B0_r_addr, 16'd0};
                    if (i_B0_write_req) req_p1 = {2'b00, 1'b1, i_B0_w_addr, i_B0_w_data};
                    if (i_B2_read_req)  req_p2 = {2'b10, 1'b0, i_B2_r_addr, 16'd0};
                    if (i_B2_write_req) req_p2 = {2'b10, 1'b1, i_B2_w_addr, i_B2_w_data};
                end
                if (B0_rq && B3_rq) begin
                    if (i_B0_read_req)  req_p1 = {2'b00, 1'b0, i_B0_r_addr, 16'd0};
                    if (i_B0_write_req) req_p1 = {2'b00, 1'b1, i_B0_w_addr, i_B0_w_data};
                    if (i_B3_read_req)  req_p2 = {2'b11, 1'b0, i_B3_r_addr, 16'd0};
                    if (i_B3_write_req) req_p2 = {2'b11, 1'b1, i_B3_w_addr, i_B3_w_data};
                end
            ...
            3'd3 : begin
                if (!B0_rq) begin
                    ...
                    if (i_B2_read_req)  req_p2 = {2'b10, 1'b0, i_B2_r_addr, 16'd0};
                    if (i_B2_write_req) req_p2 = {2'b10, 1'b1, i_B2_w_addr, i_B2_w_data};
                    if (i_B3_read_req)  req_p3 = {2'b11, 1'b0, i_B3_r_addr, 16'd0};
                    if (i_B3_write_req) req_p3 = {2'b11, 1'b1, i_B3_w_addr, i_B3_w_data};
                end
                if (!B1_rq) begin
                    if (i_B0_read_req)  req_p1 = {2'b00, 1'b0, i_B0_r_addr, 16'd0};
                    if (i_B0_write_req) req_p1 = {2'b00, 1'b1, i_B0_w_addr, i_B0_w_data};
                ...
                if (!B3_rq) begin
                    ...
                    if (i_B1_read_req)  req_p2 = {2'b01, 1'b0, i_B1_r_addr, 16'd0};
                    if (i_B1_write_req) req_p2 = {2'b01, 1'b1, i_B1_w_addr, i_B1_w_data};
                    if (i_B2_read_req)  req_p3 = {2'b10, 1'b0, i_B2_r_addr, 16'd0};
                    if (i_B2_write_req) req_p3 = {2'b10, 1'b1, i_B2_w_addr, i_B2_w_data};
                end
                req_p4 = 39'd0;
            end
            3'd4 : begin
                ...
                if (i_B2_read_req)  req_p3 = {2'b10, 1'b0, i_B2_r_addr, 16'd0};
                if (i_B2_write_req) req_p3 = {2'b10, 1'b1, i_B2_w_addr, i_B2_w_data};
                if (i_B3_read_req)  req_p4 = {2'b11, 1'b0, i_B3_r_addr, 16'd0};
                if (i_B3_write_req) req_p4 = {2'b11, 1'b1, i_B3_w_addr, i_B3_w_data};
            end
            default : begin
                req_p1 = 39'd0;
                req_p2 = 39'd0;
