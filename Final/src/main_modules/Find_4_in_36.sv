...
always_ff @(posedge i_clk or negedge i_rst) begin
    if (!i_rst) begin
        ...
        if (cnt == 0) begin
            ...
            cnt <= cnt + 1;
            if (top_1_id != 0 && top_1_amp > 32'h00000FFF) notes_r[36 - top_1_id] <= 1;
        end else if (cnt == 38) begin
            cnt <= cnt + 1;
            if (top_2_id != 0 && top_2_amp > 32'h00000FFF) notes_r[36 - top_2_id] <= 1;
        end else if (cnt == 39) begin
            cnt <= cnt + 1;
            if (top_3_id != 0 && top_3_amp > 32'h00000FFF) notes_r[36 - top_3_id] <= 1;
        end else if (cnt == 40) begin
            cnt <= cnt + 1;
            if (top_4_id != 0 && top_4_amp > 32'h00000FFF) notes_r[36 - top_4_id] <= 1;
